...
class Form extends Base  {
	...
	public function form_start( $form ) {
		...
		echo sprintf( "<form enctype= multipart/form-data class='%s' id='%s'>%s", 'hb-ajax-form', generate_form_id( $form ), wp_nonce_field( "hb-{$form}", "hb-{$form}_nonce_field", true, false ) );
