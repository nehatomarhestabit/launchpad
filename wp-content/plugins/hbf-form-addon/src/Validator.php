...
class Validator {
	...
	public function __construct( ) {
		$this->messages = [
			'required'	=>	__( 'This field is required.', HBF_FORM ),
			'email' => __( "Please enter a valid email address.", HBF_FORM ),
			'url' => __( "Please enter a valid URL.", HBF_FORM ),
			'date' => __( "Please enter a valid date.", HBF_FORM ),
			'digits' => __( "Please enter only digits.", HBF_FORM ),
			'sameTo' => __( "Please enter the same value again.", HBF_FORM ),
			'maxlength' => __( "Please enter no more than {0} characters.", HBF_FORM ),
			'minlength' => __( "Please enter at least {0} characters.", HBF_FORM ),
			'max' => __( "Please enter a value less than or equal to {0}.", HBF_FORM ),
			'min' => __( "Please enter a value greater than or equal to {0}.", HBF_FORM ),
		];
	}
